        ...
        {suppliers?.length > 0 && (
          <View style={styles.clinicalSection}>
            ...
            <View style={styles.clinicalContent}>
              <Text style={styles.clinicalText}>
                {suppliers
                  .map(supplier => supplier.tradeName || supplier.companyName || supplier.name || 'Fornecedor não especificado')
                  .join('   •   ')
                }
              </Text>
            </View>
        ...
        <View style={styles.signatureSection}>
          ...
          <View style={styles.signatureSpace}>
            <Text style={styles.signaturePlaceholder}>
              {orderData?.doctorSignature ? '[Assinatura Digital]' : 'Assinatura não cadastrada'}
            </Text>
          </View>
