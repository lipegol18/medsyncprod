...
export function CalendarView({ appointments, onNewAppointment, onEditAppointment, onUpdateAppointment }: CalendarViewProps) {
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    if (destType === 'day') {
      ...
      const newDateTime = new Date(destDate);
      ...
      console.log('📅 Updating to date:', destDate, 'time:', newTime);
      
      // Converter a data para timestamp com a nova hora
      const newDateTime = new Date(destDate);
                          ...
                          >
                            {(provided, snapshot) => (
                              <div
                                ...
                                onClick={() => onEditAppointment(appointment)}
                                className={`text-xs p-1 rounded cursor-pointer mb-1 transition-colors ${
                        ...
                        >
                          {(provided, snapshot) => (
                            <div
                              ...
                              {...provided.dragHandleProps}
                              onClick={() => onEditAppointment(appointment)}
                              className={`p-3 rounded-lg cursor-pointer mb-2 border-l-4 transition-colors ${
                                getSurgeryTypeColor(appointment.surgeryType)
