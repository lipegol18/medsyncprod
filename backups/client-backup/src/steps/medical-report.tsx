    ...
    <Card className="bg-white rounded-lg shadow-md p-6 mb-6">
      ...
      {isScanning ? (
        ...
        <div className="mb-6 border-2 border-dashed border-neutral-300 rounded-lg p-4 bg-neutral-50">
          <div className="text-center">
            ...
            <button 
              className="bg-primary-500 text-white py-2 px-4 rounded-md hover:bg-primary-600 transition-colors"
      ...
      {procedure && procedure.description && (
        <div className="mt-6 p-4 bg-primary-50 border border-primary-100 rounded-md">
          <h4 className="font-medium text-primary-800 mb-2">Sobre o procedimento:</h4>
          <p className="text-sm text-primary-700">{procedure.description}</p>
        </div>
      )}
    </Card>
  );
