...
export function ReviewOrder({ 
  ...
  return (
    <Card className="bg-[#1a2332] rounded-lg shadow-md p-6 mb-6 border-blue-800">
      <h3 className="text-lg font-medium text-white mb-4">Revisão do Pedido Cirúrgico</h3>
      ...
      <div className="mb-6">
        ...
        <div className="bg-blue-900/30 p-4 rounded-lg border border-blue-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-blue-300">Nome do Hospital</div>
              <div className="font-medium text-white">{selectedHospital?.name || "Não informado"}</div>
            </div>
            <div>
              <div className="text-sm text-blue-300">CNPJ</div>
              <div className="font-medium text-white">{selectedHospital?.cnpj || "Não informado"}</div>
            </div>
            <div>
              <div className="text-sm text-blue-300">UF</div>
              <div className="font-medium text-white">{selectedHospital?.uf || "Não informada"}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="bg-blue-900/30 p-4 rounded-lg border border-blue-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-blue-300">Nome Completo</div>
              <div className="font-medium text-white">{patient?.fullName || "Não informado"}</div>
            </div>
            <div>
              <div className="text-sm text-blue-300">CPF</div>
              <div className="font-medium text-white">{patient?.cpf || "Não informado"}</div>
            </div>
            <div>
              <div className="text-sm text-blue-300">Data de Nascimento</div>
              <div className="font-medium text-white">
                {patient?.birthDate ? formatDate(patient.birthDate) : "Não informada"}
              </div>
            </div>
            <div>
              <div className="text-sm text-blue-300">Convênio</div>
              <div className="font-medium text-white">
                {patient?.insurance 
      ...
      <div className="mb-6">
        <h4 className="font-medium text-white mb-2 flex items-center">
          <FileText className="mr-1 h-4 w-4 text-blue-400" />
          Procedimento
        </h4>
        <div className="bg-blue-900/30 p-4 rounded-lg border border-blue-800">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <div className="text-sm text-blue-300">Tipo de Procedimento</div>
              <div className="font-medium text-white">{procedure?.name || "Não informado"}</div>
            </div>
            <div>
              <div className="text-sm text-blue-300">Data Prevista</div>
              <div className="font-medium text-white">{procedureDate ? formatDate(procedureDate) : "Não informada"}</div>
            </div>
          </div>
          {reportContent && (
            <div className="mt-3">
              <div className="text-sm text-blue-300">Descrição do Laudo</div>
              <div className="text-sm mt-1 text-white">{reportContent}</div>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="mb-6">
        <h4 className="font-medium text-white mb-2 flex items-center">
          <BriefcaseMedical className="mr-1 h-4 w-4 text-blue-400" />
            ...
            <Table className="border-collapse">
              <TableHeader>
                <TableRow className="border-b border-blue-800">
                  ...
                  <TableHead className="text-blue-300">Fabricante</TableHead>
                  <TableHead className="text-blue-300">Qtd.</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {selectedItems.map(({ item, quantity }) => (
                  <TableRow key={item.id} className="border-b border-blue-800 hover:bg-blue-900/50">
                    <TableCell className="text-white">{item.name}</TableCell>
                    <TableCell className="text-sm text-blue-400">{item.code}</TableCell>
                    <TableCell className="text-sm text-blue-300">{item.manufacturer}</TableCell>
                    <TableCell className="text-sm text-blue-300">{quantity}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
      ...
      <div className="mb-6">
        <h4 className="font-medium text-white mb-2">Observações Adicionais</h4>
        <Textarea
          className="w-full bg-[#1a2332] text-white border-blue-800 focus:border-blue-600 focus:ring-blue-600"
          rows={2}
