    ...
    <div className="min-h-screen flex flex-col bg-[#1a2332]">
      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-6">
          ...
          <div className="mb-8 text-center bg-[#162130] rounded-md p-6 border border-blue-900 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <Card className="border-blue-800 bg-[#1a2332]/80 shadow-lg">
              <CardHeader className="pb-2">
                <CardTitle className="flex items-center text-white">
                  <FileCheck className="mr-2 h-5 w-5 text-blue-400" />
                  {t('home.orders.title')}
                </CardTitle>
                <CardDescription className="text-blue-300">
              ...
              <CardContent className="pb-3">
                ...
                {!isLoading && (
                  <div className="mb-4 p-2 bg-blue-900/30 rounded-md text-center">
                    <span className="text-xl font-semibold text-white">{orderCount}</span>
                    <span className="text-blue-200 ml-2 text-sm">pedido{orderCount !== 1 ? 's' : ''}</span>
                  </div>
                )}
                <Button 
                  variant="outline" 
                  className="w-full border-blue-700 text-blue-300 hover:bg-blue-900/50 mt-2" 
          ...
          {/* Card de Relatórios */}
          <Card className="border-blue-800 bg-[#1a2332]/80 shadow-lg mb-6">
            <CardHeader className="pb-2">
              <CardTitle className="flex items-center text-white">
