      ...
      upload.single('pdf')(req, res, function(err) {
        ...
        (async () => {
          try {
            ...
            // Remover PDFs antigos e adicionar o novo
            const filteredAttachments = currentAttachments.filter((att: any) => att.type !== 'pdf');
            const updatedAttachments = [...filteredAttachments, pdfAttachment];
